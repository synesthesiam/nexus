...
#region Public Members
    ...
    public SizeF Measure(string str)
    {
      ...
      return new SizeF(buffer.Width, buffer.Height);
    }
    ...
    public void Render(string str, Color color)
    {
      ...
      GL.TexCoord2(0, 1);
      GL.Vertex2(0, buffer.Height);

      GL.TexCoord2(1, 1);
      GL.Vertex2(buffer.Width, buffer.Height);

      GL.TexCoord2(1, 0);
      GL.Vertex2(buffer.Width, 0);
  ...
  public class TextBuffer
  {
    ...
    public TextBuffer(string str, Brush brush, Font font)
    {
      ...
      Width = (int)Math.Ceiling(strSize.Width);
      Height = (int)Math.Ceiling(strSize.Height);
